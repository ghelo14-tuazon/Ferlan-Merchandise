...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <a href="{{ route('user.order.show', $order->id) }}" class="btn btn-warning btn-sm mr-1" style="border-radius: 50%;" data-toggle="tooltip" title="View" data-placement="bottom"><i class="fas fa-eye"></i></a>
