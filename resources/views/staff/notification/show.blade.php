<div id="notifications">
    ...
    <a class="dropdown-item d-flex align-items-center" target="_blank">
        ...
        @endforeach
         ...
         <a class="dropdown-item text-center small text-gray-500" href="{{route('staff.all.notification')}}">Show All Notifications</a>
        <a class="dropdown-item text-center small text-gray-500" href="{{ route('reset.notifications') }}">Mark All as Read</a>
