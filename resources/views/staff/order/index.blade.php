...
@endif
    ...
    <a href="{{ route('staff.order.show', $order->id) }}" class="btn btn-warning btn-sm mr-1" style="height: 30px; width: 30px; border-radius: 50%;" data-toggle="tooltip" title="View" data-placement="bottom"><i class="fas fa-eye"></i></a>
    ...
    <a href="{{ route('staff.order.edit', $order->id) }}" class="btn btn-primary btn-sm mr-1" style="height: 30px; width: 30px; border-radius: 50%;" data-toggle="tooltip" title="Edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
        ...
        <span style="float:right">@include('staff.pagination.custom', ['paginator' => $orders])</span>
@else
