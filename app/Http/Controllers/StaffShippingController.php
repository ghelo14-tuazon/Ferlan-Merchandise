...
class StaffShippingController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('staff.shipping.index')->with('shippings',$shipping);
    }
    ...
    {
        return view('staff.shipping.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('staff.shipping.edit')->with('shipping',$shipping);
    }
