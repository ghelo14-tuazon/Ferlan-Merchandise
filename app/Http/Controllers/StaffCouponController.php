...
class StaffCouponController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staff.coupon.index')->with('coupons',$coupon);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('staff.coupon.index');
    }
    ...
    public function edit($id)
    {
        ...
        if($coupon){
            return view('staff.coupon.edit')->with('coupon',$coupon);
        }
        else{
            return view('staff.coupon.index')->with('error','Coupon not found');
        }
    }
